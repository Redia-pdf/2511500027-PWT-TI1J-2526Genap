...
<div class="content">
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title-extra-bold mb-2; font-weight-bold">HALO, <?= $data['nm_guru']; ?> 👋</h5>
                <p class="card-text mb-0">
                    ...
                    ?>, dan Selamat Datang, Bapak/Ibu Guru di Website Sekolah.</p>
                    <p class="mb-0">Terus Semangat Mengajar dan Semoga Harimu Menyenangkan!</p>
            </div>
        </div>
    </div>
</div>          
