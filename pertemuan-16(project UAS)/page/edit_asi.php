...
<?php
$id_asi = $_GET['id'];
$data = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM pemberian_asi WHERE id_asi='$id_asi' "));
if (isset($_POST['simpan'])) {
    ...
    echo "<meta http-equiv='refresh' content='1;url=index.php?page=asi'>";
}
?>
