                ...
                <body class="hold-transition sidebar-mini">
                  <div class="wrapper">
                    ...
                    <aside class="main-sidebar elevation-4" style="background:#EC407A;">
                      <!-- Brand Logo -->
                      <a href="index.php" class="brand-link text-white">
                      ...
                      <div class="sidebar">
                        ...
                        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                          <div class="image">
                            <img src="dist/img/avatar.png" class="img-circle elevation-4" alt="User Image">
                          </div>
                          <div class="info">
                            <a href="#" class="brand-link text-white"><?= $_SESSION['username']; ?></a>
                          </div>
                        </div>
                          ...
                          <ul class="nav nav-pills nav-sidebar flex-column"
                            ...
                            <li class="nav-item menu-open">
                              ...
                              <ul class="nav nav-treeview">
                                <li class="nav-item">
                                  <a href="index.php?page=ibu" class="nav-link">
                                ...
                                <li class="nav-item">
                                  <a href="index.php?page=bayi" class="nav-link">
                            ...
                            <li class="nav-item menu-open">
                              ...
                              <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                  <a href="index.php?page=asi" class="nav-link">
                                ...
                                <li class="nav-item">
                                  <a href="index.php?page=berat_badan" class="nav-link">
