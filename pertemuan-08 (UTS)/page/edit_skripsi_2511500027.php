                    ...
                    <div class="card-body p-2">
                        <form method="post" action="">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="semester_027" required>
                                    <option value="" disabled selected>Pilih Semester</option>
                                    <option value="Ganjil" <?= ($edit['semester_027'] == 'Ganjil') ? 'selected' : ''; ?>>Ganjil</option>
                                    <option value="Genap" <?= ($edit['semester_027'] == 'Genap') ? 'selected' : ''; ?>>Genap</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="thn_ajaran_027">Tahun Ajaran</label>
                                <select class="form-control" name="thn_ajaran_027"required>
                                    <option value="">Pilih Tahun Ajaran</option>
                                    <option value="2022/2023"<?= ($edit['thn_ajaran_027'] == '2022/2023') ? 'selected' : ''; ?>>2022/2023</option>
                                    <option value="2023/2024"<?= ($edit['thn_ajaran_027'] == '2023/2024') ? 'selected' : ''; ?>>2023/2024</option>
                                    <option value="2024/2025"<?= ($edit['thn_ajaran_027'] == '2024/2025') ? 'selected' : ''; ?>>2024/2025</option>
                                    <option value="2025/2026"<?= ($edit['thn_ajaran_027'] == '2025/2026') ? 'selected' : ''; ?>>2025/2026</option>
                                    <option value="2026/2027"<?= ($edit['thn_ajaran_027'] == '2026/2027') ? 'selected' : ''; ?>>2026/2027</option>
                                </select>
                            </div>
