...
if(isset($_POST['tambah'])){
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO guru values ('$kd_guru','$nm_guru','$jenkel','$pend_terakhir','$hp','$alamat')") or die(mysqli_error($koneksi));
     $insertuser = mysqli_query($koneksi, "INSERT INTO users (username, password, role) VALUES ('$kd_guru', '1234', 'guru')") or die(mysqli_error($koneksi));
