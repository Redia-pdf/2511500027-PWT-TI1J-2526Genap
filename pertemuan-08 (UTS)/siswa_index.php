        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="#" class="brand-link">
                    <span class="brand-text font-weight-regular">Siswa</span>
                </a>
                ...
                <div class="sidebar">
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="info">
                            <a href="#" class="d-block" style="font-family: Arial, sans-serif; font-weight: regular;"><?= $data['nm_siswa']; ?></a>
                        </div>
                    </div>
               ...
               with font-awesome or any other icon font library -->
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="siswa_index.php?page=biodata" class="nav-link active">
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="siswa_index.php">Home</a></li>
